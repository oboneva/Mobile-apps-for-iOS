...
class ToolboxItemOptionsControllerTests: XCTestCase {
    ...
    override func setUp() {
        super.setUp()
        toolbarItemOptionsController = Storyboard.toolboxItem.viewController(
            fromClass: ToolboxItemOptionsViewController.self)
    }
    ...
    func testDataSourceForArrows() {
        ...
        XCTAssertTrue( toolbarItemOptionsController.itemOptionsCollectionView.dataSource?.isKind(
            of: ArrowsCollectionViewDataSource.self) ?? false)
    }
    ...
    func testDataSourceForShapes() {
        ...
        XCTAssertTrue( toolbarItemOptionsController.itemOptionsCollectionView.dataSource?.isKind(
            of: ShapesCollectionViewDataSource.self) ?? false)
    }
    ...
    func testDelegateMethodIsCalledOnDidSelectItem() {
        ...
        toolbarItemOptionsController.collectionView(toolbarItemOptionsController.itemOptionsCollectionView,
                                                    didSelectItemAt: IndexPath(item: 1, section: 1))
    ...
    func testDidChooseOptionIsNotCalledWhenIndexIsOutOfBounds() {
        ...
        toolbarItemOptionsController.collectionView(toolbarItemOptionsController.itemOptionsCollectionView,
                                                    didSelectItemAt: IndexPath(item: 10, section: 10))
